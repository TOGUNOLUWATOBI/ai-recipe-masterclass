...
export const translations = {
  en: {
    ...
    termsGateIntro: "By continuing, you agree to our:",
    termsGateAcceptButton: "I Agree & Continue",
    termsTitle: "Terms & Conditions",
    legalLastUpdated: "Last updated: August 2026",

    settingsHeading: "Settings",
    settingsDeleteMyDataButton: "Delete my data",

    privacyPolicyTitle: "Privacy Policy",
    deleteMyDataConfirmTitle: "Delete my data?",
    deleteMyDataConfirmMessage: "This clears your cart stored on this device. This cannot be undone.",
    delete: "Delete",
  ...
  no: {
    ...
    termsGateIntro: "Ved å fortsette godtar du:",
    termsGateAcceptButton: "Jeg Godtar & Fortsetter",
    termsTitle: "Vilkår og betingelser",
    legalLastUpdated: "Sist oppdatert: august 2026",

    settingsHeading: "Innstillinger",
    settingsDeleteMyDataButton: "Slett mine data",

    privacyPolicyTitle: "Personvernerklæring",
    deleteMyDataConfirmTitle: "Slette mine data?",
    deleteMyDataConfirmMessage: "Dette fjerner handlekurven lagret på denne enheten. Dette kan ikke reverseres.",
    delete: "Slett",
