...
describe("StoreCard", () => {
  ...
  it("shows a placeholder icon when there is no store logo", async () => {
    await render(<StoreCard storeName="Coop" storeLogoUrl={null} itemCount={1} discountCount={0} onPress={() => {}} />);
  ...
  it("calls onPress when tapped", async () => {
    ...
    await render(<StoreCard storeName="Coop" storeLogoUrl={null} itemCount={1} discountCount={0} onPress={onPress} />);
